 ...
 * We implement via gettimeofday (116) — always available on Linux 2.6.x and
 * avoids the 32-vs-64 struct mismatch that clock_gettime (263) also has.
 * Used by BusyBox TLS/HTTPS (clock_gettime(MONOTONIC) for timeout handling).
 */
